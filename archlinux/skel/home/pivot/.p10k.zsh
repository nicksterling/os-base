# Generated by Powerlevel10k configuration wizard on 2020-01-16 at 21:54 UTC.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: awesome-fontconfig, large icons, rainbow, flat tails, 2 lines, solid,
# left frame, light, sparse, many icons, concise, transient_prompt, instant_prompt=off.
